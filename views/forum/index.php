...
$this->title = 'The brainstorming forum - Eduardo Aparicio Cardenes';
...
$this->registerMetaTag(['name' => 'og:title', 'content' => "The brainstorming forum"], 'og:title');
...
<style>
   /*Temporary styles for coming soon*/
    .brainstorming-forum h1 {
        text-align: center;
        color: #337ab7;
        margin: 30px 0;
    }
    .brainstorming-forum img{
        margin: 50px auto;
    }
</style>
<section class="brainstorming-forum">
