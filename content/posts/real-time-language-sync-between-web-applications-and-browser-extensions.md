...
![One-way real-time language synchronisation from the web app to the browser extension](/images/blog/real-time-language-sync-between-web-applications-and-browser-extensions/one-way-language-sync-diagram.png)
...
![Two-way real-time language synchronisation between the web app and the browser extension](/images/blog/real-time-language-sync-between-web-applications-and-browser-extensions/two-way-language-sync-diagram.png)
