...
import {
  getFrontendProfileLatest,
  type FrontendProfileVersion,
...
const DEFAULT_LINKEDIN_URL = 'https://www.linkedin.com/in/eacardenes';
const latestFrontendProfile = getFrontendProfileLatest();

function mapFrontendVersionToProfileConfig(version: FrontendProfileVersion): ProfileConfig {
  return {
    title: version.title,
...
export const profileData: ProfileData = {
  frontend: mapFrontendVersionToProfileConfig(latestFrontendProfile),
  backend: {
